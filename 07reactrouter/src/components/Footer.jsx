        ...
        <footer className='bg-white border-y'>
            <div className='mx-auto w-full max-w-screen-xl px-4 py-6 lg:py-8'>
                <div className='md:flex md:justify-between'>
                    ...
                    <div>
                        <h2 className='mb-6 text-sm font-semibold text-gr-900 uppercase '>Follow Us</h2>
                    ...
                    <div>
                        <h2 className='mb-6 text-sm font-semibold text-green-900 uppercase'>Legal</h2>
                        <ul className='text-grey-500 font-medium'>
                            <li className='mb-4'>
                                <Link
                                    to="#"
                ...
                <div className='sm:flex sm:items-center sm:justify-between '>
                    ...
                    <span className='text-sm text-grey-500 sm:text-center'>&copy; 2023
                        <a href="https://Rabindra-Basnet.com"
                            className='hover:underline'
                        >Rabindra
                        </a>
                        . All Rights Reserved
